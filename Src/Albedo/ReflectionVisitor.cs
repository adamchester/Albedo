namespace Ploeh.Albedo
{
    ...
    public abstract class ReflectionVisitor<T> : IReflectionVisitor<T>
    {
        ...
        /// <summary>
        /// Allows an <see cref="LocalVariableInfoElement"/> to be 'visited'. Override this method to allow
        /// the derived visitor to observe the element.
        /// </summary>
        /// <param name="localVariableInfoElement">The <see cref="LocalVariableInfoElement"/> being visited.
        /// </param>
        /// <returns>A (potentially) new <see cref="IReflectionVisitor{T}"/> instance which can be
        /// used to continue the visiting process with potentially updated observations.</returns>
        ...
        /// <summary>
        /// Allows an <see cref="EventInfoElement"/> to be 'visited'. Override this method to allow
        /// the derived visitor to observe the element.
        /// </summary>
